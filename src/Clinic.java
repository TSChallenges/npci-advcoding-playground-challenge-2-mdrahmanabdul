...
class Clinic {
	...
	// Constructor to initialize the clinic with a queue and a set of admitted
	// patients
	public Clinic() {
	...
	public void getSchedule() {
		...
		while (!patientQueue.isEmpty()) {
			System.out.println("Scheduling the appointments for day " + dayCount);
			for(int i=0;i<patientForDay&& !patientQueue.isEmpty();i++) {
	...
	public void getAppointmentDetails(Patient patient) {
		if (admittedPatients.contains(patient)) {
			System.out.println(
					"Appointment Details: " + patient.getName() + " is scheduled on " + patient.getAppointmentDay());
		} else {
			System.out.println("Patient not found in the admitted list.");
		}
	}
